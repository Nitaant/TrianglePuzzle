...
import starting.controller.SelectController;
...
public class TrianglePuzzleApp extends JFrame {
	...
	public TrianglePuzzleApp(Model model) {
		...
		panel.addMouseListener(new MouseAdapter() { 
			...
			public void mousePressed(MouseEvent me) {
				new SelectController(model, TrianglePuzzleApp.this).process(me.getPoint());
			}
		});
	...
	public TrianglePuzzleDrawer getTrianglePuzzleDrawer() {
